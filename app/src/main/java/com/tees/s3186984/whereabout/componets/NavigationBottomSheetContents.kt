...
fun QRCodeContainer(
    ...
    qrCodeState: MutableState<Bitmap?>,
)
{
    val qrCodeBitmap = qrCodeState.value
...
fun QRCodeScanner(
    ...
    )
    {
        ...
        Text(
            text = homeViewModel.currentUser?.device?.deviceName!!,
            style = TextStyle(
                fontSize = 16.sp,
                fontWeight = FontWeight.Normal
            )
        ...
        if (!isSuccess || connectError){
            ...
            Column(
                ...
                Text(
                    modifier = Modifier.padding(start = 8.dp),
                    color = Color.Black.copy(0.75f),
                    text = "Connection tags are easy ways to identify your connections",
                    style = TextStyle(fontSize = 12.sp, fontWeight = FontWeight.Normal)
                )
                ...
                Row(
                    ...
                    TextButton(onClick = {
                        homeViewModel.createPairingConnection()
                    }) {
                        Icon(
